        ...
        <div id="main_container " className=" h-auto relative  railway lg:pl-[100px] pl-0 lg:mt-0  overflow-hidden">
            ...
            <div className="grid relative  max-w-[1550px] px-6 mx-auto z-50 ">
                ...
                <div className="grid mt-20 z-50 max-w-[1200px] justify-self-center text-[#f3efef]">
                    ...
                    <h1 className="lg:text-6xl text-4xl font-medium  mt-4">{` A fun fact about me is that I'm a self-taught freestyle frisbee pro. On the weekend, you'll find me playing on the beach.`}</h1>
                    <p className="gallery-sub-text text-4xl pt-4">{`See more of my photos and videos on`} <a className="text-[#d35e5e] text-4xl font-bold" href="https://www.instagram.com/p/ByvaP3zgatA/?utm_medium=copy_link">Instagram</a> or <a className="text-[#d35e5e] text-4xl font-bold" href="https://vm.tiktok.com/ZSefoN5AC/">TikTok</a></p>
                </div>
